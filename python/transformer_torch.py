...
def make_batch(sentences):
    input_batch = [[src_vocab[n] for n in sentences[0].split()]]    # src_vocab为dict
...
if __name__ == '__main__':
    ...
    optimizer = optim.Adam(model.parameters(), lr=0.001)    # 初始化参数

    enc_inputs, dec_inputs, target_batch = make_batch(sentences)    # size: [1, 1, embedding_size]
