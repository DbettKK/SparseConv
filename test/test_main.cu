...
void test_blas() {
    ...
    for (int i = 0; i < 5; i++) {
        ...
        tt0->initAndStart();
        for (int j = 0; j < 16; j++) {
            cublas_gemm_device(dA + j * 16 * 256, dB + j * 256 * 256, 16, 256, 256, dOut + j * 16 * 256);
        }
    ...
    for (int i = 0; i < 5; i++) {
        ...
        tt0->initAndStart();
        for (int j = 0; j < 16; j++) {
            sparse_mma_gemm_device(dA + j * 16 * 256, dB + j * 256 * 256, 16, 256, 256, false, dOut + j * 16 * 256);
        }
