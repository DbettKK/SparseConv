...
#include "../../nlp/transformer/interface/spmma_interface.cuh"
#include "../../nlp/transformer/interface/cublas_interface.cuh"
#include "../../nlp/transformer/interface/cusparse_interface.cuh"
...
void conv2d_device_cusparse(half *feature, half *kernel, int batch, int in_c, int out_c, int f_w, int f_h, int k_w, int k_h, int stride, int padding, half *out);
